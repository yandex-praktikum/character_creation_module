...
def attack(char_name: str, char_class: str) -> str:
    """Calculate attack based on chosen character."""
...
def defence(char_name: str, char_class: str) -> str:
    """Calculate defence based on chosen character."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Calculate special based on chosen character."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Make your choice in game and choose your character."""
    approve_choice: str = ''
    char_class: str = ''
